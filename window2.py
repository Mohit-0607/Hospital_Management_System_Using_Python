...
def menu():
    ...
    m=tkinter.Label(root1,text="  MENU",font='Times 20 bold italic',fg='black')
    button1=tkinter.Button(root1,text="1.PATIENT REGISTRATION",command=PAT,bg='blue',fg='black')
    button2 = tkinter.Button(root1, text="2.ROOM ALLOCATION",bg='green',fg='black',command=Room_all)
    button3 = tkinter.Button(root1, text="3.EMPLOYEE REGISTRATION",bg='blue',fg='black',command=emp_screen)
    button4 = tkinter.Button(root1, text="4.BOOK APPOINTMENT",bg='green',fg='black',command=appo)
    button5 = tkinter.Button(root1, text="5.PATIENT BILL",bg='blue',fg='black',command=BILLING)
    button6 = tkinter.Button(root1, text="6.EXIT",command=ex,bg='green',fg='black')
    m.place(x=75,y=5)
...
def IN_PAT():
    ...
    tkinter.messagebox.showinfo("Dr. GULATI DATABASE ","DETAILS INSERTED INTO DATABASE")
    conn.commit()
...
def PAT():
    ...
    rootp=tkinter.Tk()
    rootp.title("Dr. GULATI Registration FORM")
